...
use Mythic_Template\Display\MT_Render;
...
class MT_Settings {
    ...
    public static function renderPage( $args = [] ) {
        ...
        MT_Render::adminPage( 'settings', $args );
    }
    ...
    public static function input( $args = [] ) {
        ...
        MT_Render::adminField( $type, '', $args );
    }
    ...
    public static function selectFromPages( $input_name = '', $setting_name = '' ) {
        $pages = [];
        foreach( MT_WP::pages() as $page_id ) {
    ...
    public static function selectYesNo( $input_name, $setting_name = '' ) {
        self::select( [
                          ...
                          [ 'value' => '0', 'label' => __( 'No', MT_TEXT_DOMAIN ) ],
                          [ 'value' => '1', 'label' => __( 'Yes', MT_TEXT_DOMAIN ) ],
                      ] );
    }
    ...
    public static function select( $args = [], $options = [] ) {
        ...
        if( !empty( $args['empty_value'] ) ) {
            array_unshift( $options, [
                'value' => '',
                'label' => __( '- - Please Select - -', MT_TEXT_DOMAIN ),
            ] );
        }
        ...
        MT_Render::adminField( 'select', '', $args );
    }
