    ...
    <div class="row h-100 align-items-start">
        <div class="preview p-3 col-6 bg-light">
            <div class="preview__canvasWrapper text-center">
                ...
                <div class="preview__canvasToolbar text-center my-3">
                    ...
                    <button type="button" class="preview__toggleLock btn btn-danger text-white"><i
                                class="fas fa-lock"></i> <span>Locked</span>
                    </button>
                    <button type="button" class="preview__toggleZoom btn btn-warning"><i class="fas fa-search-plus"></i>
                        Toggle Zoom
                    </button>
        ...
        <div class="configWrapper col p-0">
            <form class="config" method="post" action="" enctype="multipart/form-data">
                <input type="hidden" name="resultPNGData" class="config_resultPNGDataInput" value="">
                ...
                <div class="config__upload config__upload--bordered card p-4 m-0">
                    <div class="input-group mb-3 align-items-center">
                        <div class="input-group-prepend">
                            <button title="Remove design image" type="button"
                                    class="config__removeImage m-0  input-group-text btn btn-danger">&times;
                            </button>
                        </div>
                        <div class="px-2">
                            <small>Design</small>
                        ...
                        <?php
                        $design_label_text = !empty( $design_file_name ) ? $design_file_name : '';
                        MC_Forms::renderFileInput( 'design', 'config__uploadDesign', $design_label_text ) ?>
                        <div class="input-group-append px-2">
                            <input type="checkbox" class="config__uploadDesignMaskTransparent"
                                   aria-label="Use transparent mask of the design image"
                                   title="Use transparent mask of the design image">
                        </div>
                        <div class="input-group-append" style="width: 50px">
                            <input title="Pick the background color here" class="config__uploadDesignColor" type="color"
                                   value="#ffffff" />
                        </div>
                    </div>
                    <div class="input-group align-items-center">
                        <div class="input-group-prepend">
                            <button title="Remove secondary image" type="button"
                                    class="config__removeSecondary m-0 input-group-text btn btn-danger">
                                &times;
                            </button>
                        </div>
                        <div class="input-group-prepend">
                        ...
                        <!-- TODO: add signature init value if it's existing and check input name - "design"-->
                        <?php MC_Forms::renderFileInput( 'design', 'config__uploadDesignSecondary' ) ?>
                        <div class="input-group-append px-2">
                            <input checked type="checkbox" class="config__uploadSecondaryMaskTransparent"
                                   aria-label="Use transparent mask of the secondary image"
                                   title="Use transparent mask of the secondary image">
                        </div>
                        <div class="input-group-append" style="width: 50px">
                            <input title="Pick the background color here" class="config__uploadDesignSecondaryColor"
                                   type="color"
                                   value="#ffffff" />
                        </div>
                    </div>
                ...
                <div class="config__options card p-3 m-0">
                    <div class="row p-3 h-100 align-items-start">
                        <div class="col card config__scrollPane config__preconfigurations">
                            ...
                            <template class="config__preconfigurationsTemplate">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">Preconfiguration</label>
                                </div>
                            </template>
                        ...
                        <div class="col card config__scrollPane config__maskElements">
                            ...
                            <div class="config__maskElementsOptions"></div>
                        </div>
                    </div>
                </div>
            </form>
