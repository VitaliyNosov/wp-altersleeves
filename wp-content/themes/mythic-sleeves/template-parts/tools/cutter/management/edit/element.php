...
<form action="/cutter-management" method="GET">
    <div class="mb-3 row align-items-start">
        <label for="input-element-name" class="col-sm-2 col-form-label fw-bold">Name</label>
        <div class="col-sm-10">
    ...
    <div class="mb-3 row align-items-start">
        <label for="input-element-description" class="col-sm-2 col-form-label fw-bold">Description</label>
        <div class="col-sm-10">
    ...
    <div class="mb-3 row align-items-start">
        <label class="col-sm-2 fw-bold form-check-label" for="input-element-locked">
            Locked Element
        </label>
    ...
    <div>
        <a href="javascript:void(0);" id="action-create-element-variation" data-target="<?= $element_id ?>"
           class="action-init-delete delete-hide btn btn-primary blue--button my-2">Create Variation</a>
    </div>
