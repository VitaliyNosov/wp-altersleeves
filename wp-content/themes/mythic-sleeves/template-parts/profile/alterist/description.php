...
$description = get_the_author_meta( 'description', $idAlterist );
$charity     = MC_User::charity( $idAlterist );
    ...
    <?php if( isset( $charity['status'] ) && !empty($charity['status']) ): ?>
        ...
        <div class="my-3 p-3 bg-light rounded">
            <div class="row align-items-start">
                ...
                <?php endif ?>
                <div class="charity_data_cont col">
                ...
                <div class="charity_button_cont col-12">
                    <div class="float-left">
                        <?php if( !MC_Woo_Cart_Functions::empty() ) : ?>
                            <a href="/cart?charity_creator_id=<?= $idAlterist ?>" class="btn btn-info">Support & Save</a>
                        <?php else : ?>
                            <a href="#" class="btn btn-info charity_support" data-charity_user_id="<?= $idAlterist ?>">Support & Save</a>
                        <?php endif; ?>
                    </div>
