<template>
	<div class="page-section featured-products-section" v-bind:style="{background: importedData.logo}">
		<div class="container section-heading">
			<div class="row">
				<div class="col-lg-3">
					<h2 class="page-section-title">{{ importedData.title }}</h2>
					<a v-bind:href="importedData.link.url" class="button button-primary-gradient">{{ importedData.link.title }}</a>
				</div>
				<div class="col-lg-9">
					<div class="description" v-html="importedData.description"></div>
				</div>
			</div>
		</div>
		<div class="container-right">
			<div class="section-slider alter-sleeves results-products-slider">
