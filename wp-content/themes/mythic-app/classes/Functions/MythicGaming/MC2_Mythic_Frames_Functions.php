...
namespace Mythic\Functions\MythicGaming;

use MC2_Alter_Functions;
...
class MC2_Mythic_Frames_Functions {
    ...
    public static function creatures() {
        ...
        foreach( $eras as $era_key => $era ) {
            ...
            foreach( $printings as $printing_id ) {
                ...
                if( $printing_image == MC2_Mtg_Card_Functions::default_image() || empty( $printing_image ) ) continue;
    ...
    public static function update_ks_image( $team_id = 0 ) {
        if( !MC2_Environment::live() ) return;
        ...
        foreach( $teams as $id => $team ) {
            ...
            if( $count == 4 ) {
                ...
                $canvas               = ImageManagerStatic::make( $canvas_path );
                $commander_1_printing = MC2_Vars::stringContains( $commander_1_printing,
                ...
                $canvas               = ImageManagerStatic::make( $canvas_path );
                $commander_2_printing = MC2_Vars::stringContains( $commander_2_printing,
