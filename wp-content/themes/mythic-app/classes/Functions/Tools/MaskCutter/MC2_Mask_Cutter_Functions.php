...
use Mythic\Functions\MC2_Alter_Functions;
...
/**
 * Class MC2_Mask_Cutter_Functions
 *
...
class MC2_Mask_Cutter_Functions {
    ...
    public static function data( $printing_id = 0, $product_id = 0 ) : array {
        ...
        if(!empty($product_id)){
			$product_image = trim( MC2_WP::meta( MC2_Alter::META_FILE_ORIGINAL, $product_id ) );
    ...
    public static function upload() {
        ...
        //unlink( $file_path );
        $url             = str_replace( get_home_url(), '', MC2_Url::pathToUrl( $stored_path ) );
