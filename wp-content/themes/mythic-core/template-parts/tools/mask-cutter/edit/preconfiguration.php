...
<form action="/cutter-management" method="GET">
    <div class="mb-3 row align-items-start">
        <label for="input-preconfiguration-name" class="col-sm-2 col-form-label font-weight-bold">Name</label>
        <div class="col-sm-10">
    ...
    <div class="mb-3 row align-items-start">
        <label for="input-preconfiguration-description" class="col-sm-2 col-form-label font-weight-bold">Description</label>
        <div class="col-sm-10">
