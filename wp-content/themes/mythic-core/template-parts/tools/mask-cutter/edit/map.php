...
<form>
    ...
    <div class="mb-3 row align-items-start">
        <label for="input-map-name" class="col-sm-2 col-form-label font-weight-bold">Name</label>
        <div class="col-sm-10">
                    ...
                    <div class="col-6">
                        <div id="target-<?= $element_id ?>" data-element="<?= $element_selected_variation_id ?>"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 mb-3">
                                    <label class="font-weight-bold" for="input-element-variation">Element Variation</label>
        ...
        <div id="map-preview-container" class="col-md-4 p-0 position-relative">
            <div id="map-affix">
                <div id="map-preview" class="bg-primary position-relative p-3">
                    <img class="" src="<?= MC_Mtg_Printing_Functions::saPrintingImg( $map_printing_id ) ?>" id="element-preview-0"
