...
$variations_attr = function_exists( 'wc_esc_json' ) ? wc_esc_json( $variations_json ) : _wp_specialchars( $variations_json, ENT_QUOTES, 'UTF-8',
                                                                                                          true );
        ...
        <div class="variations">
            <?php foreach( $attributes as $attribute_name => $options ) : ?>
                ...
                <div class="mb-3">
                    ...
                    <?php
                    $default =  __( 'Choose an option', 'woocommerce' );
                    if( $attribute_name == 'pa_design-team' ) {
                        $default = 'Select a design';
                    } else if( $attribute_name == 'pa_pack-type' ) {
                        $default = 'Select a pack type';
                    }
