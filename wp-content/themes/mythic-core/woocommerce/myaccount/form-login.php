...
<div class="p-4">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <button class="nav-link <?= empty( $_GET['action'] ) ? 'active' : ''; ?>" id="pills-login-tab" data-bs-toggle="pill"
                data-bs-target="#pills-login" type="button" role="tab"
                aria-controls="pills-login" aria-selected="true">Log In</button>
        </li>
        <li class="nav-item" role="presentation">
        <button class="nav-link <?= !empty( $_GET['action'] ) ? 'active' : ''; ?>" id="pills-register-tab" data-bs-toggle="pill"
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show <?= empty( $_GET['action'] ) ? 'active show' : ''; ?>" id="pills-login" role="tabpanel"
             aria-labelledby="pills-login-tab">

            <p>Have an Alter Sleeves or Mythic Gaming account already?<br>You can use that with no registration required!</p>
        ...
        <div class="tab-pane fade <?= !empty( $_GET['action'] ) ? 'active show' : ''; ?>" id="pills-register" role="tabpanel"
