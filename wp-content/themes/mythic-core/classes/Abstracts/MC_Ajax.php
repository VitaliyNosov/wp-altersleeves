...
use Mythic_Core\Functions\MC_Ajax_Functions;
...
abstract class MC_Ajax {
    ...
    public function init() {
        ...
        if( !empty( MC_Ajax_Functions::verifyWpNonce( static::generate_nonce_action() ) ) ) $this->execute();
    ...
    public static function render_nonce( $echo = true ) {
        ...
        MC_Ajax_Functions::render_nonce( $action, $echo );
    }
