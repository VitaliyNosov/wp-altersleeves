...
/**
 * Class MC_Transaction_Type_Functions
 *
 * @package Mythic_Core\Abstracts
 */
abstract class MC_Transaction_Type_Functions {
    ...
    public function __construct( &$args ) {
        ...
        $data = [
            ...
            'site_id'    => $this->prepareSiteId( $args )
        ];
    ...
    public function prepareSiteId( &$args ) : string {
        return $args['site_id'] ?? get_current_blog_id();
    }
    ...
    public static function getTransactionData( $id ) {
        return MC_Transaction_Functions::getTransactionData( $id );
    }
    
    public static function getTransactionsData( $user_id = 0, $order_id = 0, $product_id = 0, $limit = 0, $offset = 0 ) {
        return MC_Transaction_Functions::getTransactionsData( static::$transaction_key, $user_id, $order_id, $product_id, $limit, $offset );
    }
