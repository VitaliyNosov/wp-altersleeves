...
class MC_Colors {
     ...
     * @param $b2
     */
    public static function colorReplaceRgb( $img, $r1, $g1, $b1, $r2, $g2, $b2 ) {
     ...
     * @return string
     */
    public static function colorNameFromHex( $value = '', $full = false ) : string {
        $colors = self::colors( $full );
        
        $distances = [];
        $val       = self::htmlToRgb( $value );
        foreach( $colors as $name => $c ) {
            $distances[ $name ] = self::distance( $c, $val );
        }
     ...
     * @return int[][]
     */
    public static function colors( $full = true, $readable = true ) : array {
        $colors = $full ? self::listColorsFull() : self::listColorsSimple();
        if( !$readable ) return $colors;
        foreach( $colors as $key => $color ) {
            $colors[ ucwords( $key ) ] = $color;
            unset( $colors[ $key ] );
        }
     ...
     * @return int[][]
     */
    public static function listColorsFull() : array {
        return [
     ...
     * @return int[][]
     */
    public static function listColorsSimple() : array {
        return [
            "black"   => [ 0, 0, 0 ],
            "green"   => [ 0, 128, 0 ],
            "silver"  => [ 192, 192, 192 ],
     ...
     * @return array|int[]
     */
    public static function htmlToRgb( $color ) : array {
        if( $color[0] == '#' ) {
     ...
     * @return float
     */
    public static function distance( array $color1, array $color2 ) : float {
