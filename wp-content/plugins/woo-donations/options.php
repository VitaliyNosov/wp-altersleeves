...
<div class="wdgk_wrap ">
	...
	<form method="post">	
			...
			?>
		<div class="wdgk_donation_setting <?php if($tab != null){ _e('wdgk-hidden'); } ?>">

			<h2><?php _e('Woocommerce Donation Settings','woo-donations'); ?></h2>
		...
		<div class="wdgk_donation_setting <?php if($tab != "donation-label"){ _e('wdgk-hidden'); } ?>">
		...
		<div class="wdgk_pro_details <?php if($tab != "donation-pro-version"){ _e('wdgk-hidden'); } ?>">
			...
			<ul>
				...
				<li><?php _e('Configurable screen position for donation form in checkout page.','woo-donations'); ?></li>
